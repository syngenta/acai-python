...
class RouterMappingTest(unittest.TestCase):
    ...
    strict_json_bad_body_event = mock_request.get_strict_json_bad_body_post()
    json_content_type_without_body_event = mock_request.get_json_content_type_without_body()
    ...
    handler_mapping = {
        ...
        'strict-json': 'tests/mocks/apigateway/router/mapping_handlers/strict_json.py',
    ...
    def test_invalid_json_body_read_through_request_json_returns_400(self):
        router = Router(
            base_path=self.base_path,
            handlers=self.handler_mapping,
            schema=self.schema_path,
        ...
        result = router.route(self.strict_json_bad_body_event, None)
        json_dict_response = json.loads(result['body'])
        self.assertEqual(400, result['statusCode'])
        self.assertDictEqual(self.expected_open_headers, result['headers'])
        self.assertEqual('body', json_dict_response['errors'][0]['key_path'])

    def test_json_content_type_without_body_does_not_error(self):
        router = Router(
            base_path=self.base_path,
            handlers=self.handler_mapping,
            schema=self.schema_path,
        ...
        result = router.route(self.json_content_type_without_body_event, None)
    ...
    def test_basic_mapping_routing_works_with_validate_response_body(self):
        dynamic_event = self.mock_request.get_dynamic_event(
    ...
    def test_auto_validate_works_and_passes_proper_dynamic_route_request(self):
        ...
        json_dict_response = json.loads(result['body'])
        self.assertEqual(200, result['statusCode'])
        self.assertDictEqual({'router_mapping_auto': body}, json_dict_response)
    ...
    def test_auto_validate_works_and_passes_proper_dynamic_route_request_with_optional_params(self):
        ...
        json_dict_response = json.loads(result['body'])
        self.assertEqual(200, result['statusCode'])
        self.assertDictEqual({'router_mapping_optional': True}, json_dict_response)
    ...
    def test_basic_mapping_routing_works_with_auto_validate_and_with_auth_function_called(self):
        dynamic_event = self.mock_request.get_dynamic_event(
            headers={'x-api-key': 'some-key'},
            path='unit-test/v1/auto',
            proxy='auto',
    ...
    def test_basic_mapping_routing_works_with_auto_validate_response_body(self):
        dynamic_event = self.mock_request.get_dynamic_event(
            headers={'x-api-key': 'some-key'},
            path='unit-test/v1/auto',
            proxy='auto',
    ...
    def test_basic_mapping_routing_fails_with_auto_validate_response_body(self):
        dynamic_event = self.mock_request.get_dynamic_event(
            headers={'x-api-key': 'some-key'},
            path='unit-test/v1/auto',
            proxy='auto',
    ...
    def test_basic_mapping_routing_fails_with_response_body(self):
        dynamic_event = self.mock_request.get_dynamic_event(
            headers={'x-api-key': 'some-key'},
            path='unit-test/v1/auto',
            proxy='auto',
